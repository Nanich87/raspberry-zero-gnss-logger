...
static void cmd_mark(char **args, int narg, vt_t *vt)
{
    ...
    vt_printf(vt,"$MARK,%d,%.3f,%d,%.9f,%.9f,%.4f,%.4f,%.4f,%.4f\n",week,tow,svr.rtk.sol.stat,pos[0]*R2D,pos[1]*R2D,pos[2],svr.rtk.sol.rr[0],svr.rtk.sol.rr[1],svr.rtk.sol.rr[2]);
